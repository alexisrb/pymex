<div class="pt-4">
    <div class="card">
        ...
        <h5 class="text-center my-2">Todos los Ciudadanos con Firmas</h5>
        </div>
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-7 col-md-7 col-sm-7">
                    <a type="button" class="btn btn-success" href="{{ route('admin.signatures.create', $user) }}">Agregar Usuario </a>
                </div>
            </div>
        </div>
    </div>
