                        ...
                        <div class="col m-2">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="number" id="id" class="form-control" wire:model="id_fis" placeholder="Ingrese el número de Fiscalización">
                                    @error('id_fis') <span class="text-danger error">{{ $message }}</span>@enderror
                                </div>
